...
const ProgramBar = () => {
    ...
    useEffect(() => {
        // setInterval(() => {
        axios.get(`${import.meta.env.VITE_POCKETBASE_URL}api/collections/program/records?perPage=100`)
            .then(response => {
    ...
    return (
        <div className='bg-light text-dark'>
            <h2 className='text-center nav-button'>จำนวนครั้งผู้เข้าเยี่ยมชมในแต่ละสาขา</h2>
